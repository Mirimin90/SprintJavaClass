...
1. Se crea un set de pruebas con Junit.
2. Se agrega variable de tipo de usuario para diferenciar entre cliente, profesional y administrativo.
3. Se agrega variable de apellido a clase super usuario.
4. Se dividen los services (contenedor), en 3 clases para ser utilizadas de mejor manera:
con ContenedorUs (manipula los datos de usuario), ContenedorAcc (manipula los datos de accidentes) y ContenedorCap (manipula los datos de capacitaciones).
5. Se crea una clase de utilitarios para albergar los métodos comunes y ´puedan ser llamados desde 
las clases que los deseen utilizar. 
